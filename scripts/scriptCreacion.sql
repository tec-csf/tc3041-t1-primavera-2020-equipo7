...
CREATE TABLE v_federal(id_mesa INT NOT NULL, fecha_mesa_inicio DATE NOT NULL, fecha_mesa_final DATE NOT NULL, fecha_partido_inicio DATE NOT NULL, fecha_partido_final DATE NOT NULL, siglas VARCHAR(10) NOT NULL, tipo_voto INT, fecha_hora_voto TIMESTAMP(12) NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY(id_mesa, siglas), FOREIGN KEY(id_mesa, fecha_mesa_inicio, fecha_mesa_final) REFERENCES mesa(id_mesa, fecha_mesa_inicio, fecha_mesa_final), FOREIGN KEY(siglas, fecha_partido_inicio, fecha_partido_final) REFERENCES partido(siglas, fecha_partido_inicio, fecha_partido_final))

CREATE TABLE v_municipal(id_mesa INT NOT NULL, fecha_mesa_inicio DATE NOT NULL, fecha_mesa_final DATE NOT NULL, fecha_partido_inicio DATE NOT NULL, fecha_partido_final DATE NOT NULL, siglas VARCHAR(10) NOT NULL, tipo_voto INT, fecha_hora_voto TIMESTAMP(12) NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY(id_mesa, siglas), FOREIGN KEY(id_mesa, fecha_mesa_inicio, fecha_mesa_final) REFERENCES mesa(id_mesa, fecha_mesa_inicio, fecha_mesa_final), FOREIGN KEY(siglas, fecha_partido_inicio, fecha_partido_final) REFERENCES partido(siglas, fecha_partido_inicio, fecha_partido_final))

CREATE TABLE votante(ife_pasaporte VARCHAR(50) NOT NULL, fecha_nac DATE NOT NULL, direccion VARCHAR(100) NOT NULL, nombre VARCHAR(100) NOT NULL, fecha_votante_inicio DATE NOT NULL, fecha_votante_final DATE NOT NULL, id_mesa INT NOT NULL, fecha_mesa_inicio DATE NOT NULL, fecha_mesa_final DATE NOT NULL, id_superior VARCHAR(50), orden INT NOT NULL, siglas VARCHAR(10) NOT NULL, fecha_partido_inicio DATE NOT NULL, fecha_partido_final DATE NOT NULL, tipo INT NOT NULL, sys_votante_inicio TIMESTAMP(12) NOT NULL GENERATED ALWAYS AS ROW BEGIN, sys_votante_final TIMESTAMP(12) NOT NULL GENERATED ALWAYS AS ROW END, trans_id_votante TIMESTAMP(12) NOT NULL GENERATED ALWAYS AS TRANSACTION START ID, PERIOD SYSTEM_TIME(sys_votante_inicio, sys_votante_final), PERIOD BUSINESS_TIME(fecha_votante_inicio, fecha_votante_final), PRIMARY KEY (ife_pasaporte, fecha_votante_inicio, fecha_votante_final), FOREIGN KEY(id_mesa, fecha_mesa_inicio, fecha_mesa_final) REFERENCES mesa (id_mesa, fecha_mesa_inicio, fecha_mesa_final), FOREIGN KEY (siglas, fecha_partido_inicio, fecha_partido_final) REFERENCES partido (siglas, fecha_partido_inicio, fecha_partido_final), FOREIGN KEY (id_superior, fecha_votante_inicio, fecha_votante_final) REFERENCES votante (ife_pasaporte, fecha_votante_inicio, fecha_votante_final)) 
