...
def inser_in_products(id, product_name):
    insert_command = "INSERT INTO products (id, description, start_date, end_date) VALUES ({}, '{}', '2020-04-24', '2020-05-11')".format(id, product_name)
...
def insert():
    cur = db.connection.cursor()
    vec_licores = ['vino', 'churrumais']

    for i in range(len(vec_licores)):
        inser_in_products(i+4, vec_licores[i])
